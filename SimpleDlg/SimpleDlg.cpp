...
// SimpleDlg.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект CSimpleDlgApp

CSimpleDlgApp theApp;


// инициализация CSimpleDlgApp
...
// обработчики сообщений CSimpleDlgApp
...
// CSimpleDlgApp настройка методов загрузки и сохранения
